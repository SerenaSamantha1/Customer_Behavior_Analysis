...
select subscription_status, count(customer_id) as Number_of_Customers, round(avg(purchase_amount),2) as average_spend, round(sum(purchase_amount),2) as Total_Revenue 
from customer
group by subscription_status
order by Total_Revenue desc, average_spend;
